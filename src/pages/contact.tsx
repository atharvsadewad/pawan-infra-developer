  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-white py-24 px-6">
        ...
        >
          <h3 className="text-2xl font-semibold text-center text-[#1E1E1E] mb-8 relative inline-block after:absolute after:w-16 after:h-[3px] after:bg-[#C6A45B] after:left-1/2 after:-translate-x-1/2 after:-bottom-3">
            Find Us Here
          </h3>

          <div className="rounded-2xl overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
            <iframe
